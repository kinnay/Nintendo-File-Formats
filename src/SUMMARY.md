...
- [Switch]()
	...
	- [System Save Data](libs/switch/systemsave.md)
		...
		- [8000000000000043](libs/switch/systemsave/8000000000000043.md)
...
- [SMM]()
	- [Level](games/smm/level.md)
	- [Save data](games/smm/savedata.md)
- [SMM2]()
	- [Encryption](games/smm2/encryption.md)
	- [Level](games/smm2/level.md)
	- [Ghost](games/smm2/ghost.md)
	- [Save data](games/smm2/savedata.md)
	  - [later.dat](games/smm2/savedata/later.md)
	  - [myworld.dat](games/smm2/savedata/myworld.md)
	  - [network.dat](games/smm2/savedata/network.md)
	  - [quest.dat](games/smm2/savedata/quest.md)
	  - [save.dat](games/smm2/savedata/save.md)
- [SNES (NSO)]()
